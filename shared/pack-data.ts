...
export const PACKS: PackDef[] = [
  ...
  },
  {
    ...
    tmPool: ['Solar Beam', 'Energy Ball', 'Power Whip', 'Petal Dance', 'Wood Hammer', 'Sleep Powder', 'Sludge Bomb', 'Growth', 'Horn Leech', 'Stun Spore', 'Cotton Guard'],
  ...
  },
  {
    ...
    tmPool: ['Thunder', 'Thunderbolt', 'Wild Charge', 'Volt Tackle', 'Thunder Wave', 'Signal Beam', 'Zap Cannon', 'Charge Beam', 'Spark', 'Bolt Strike', 'Fusion Bolt'],
  ...
  },
  {
    ...
    tmPool: ['Close Combat', 'Cross Chop', 'Brick Break', 'Focus Blast', 'Dynamic Punch', 'Bulk Up', 'Swords Dance', 'Sacred Sword', 'Howl', 'Work Up'],
  ...
  },
  {
    ...
    tmPool: ['Outrage', 'Brave Bird', 'Hurricane', 'Fly', 'Air Slash', 'Dragon Dance', 'Aerial Ace', 'Drill Peck', 'Air Cutter', 'Dragon Tail', 'Feather Dance', 'Acrobatics'],
  ...
  },
  {
    ...
    tmPool: ['Blizzard', 'Ice Beam', 'Surf', 'Shadow Ball', 'Earthquake', 'Iron Head', 'Hail', 'Icicle Crash', 'Glaciate'],
  ...
  },
  {
    ...
    tmPool: ['Flash Cannon', 'Iron Head', 'Meteor Mash', 'Iron Defense', 'Earthquake', 'Stone Edge', 'Iron Tail', 'Shadow Force', 'Gear Grind', 'Metal Sound', 'Acid Armor', 'Barrier'],
  ...
  },
  {
    ...
    tmPool: ['Sludge Bomb', 'Gunk Shot', 'Bug Buzz', 'X-Scissor', 'Megahorn', 'Toxic', 'Poison Sting', 'Bug Bite', 'Attack Order', 'Steamroller', 'Toxic Spikes', 'Poison Powder', 'Glare', 'Coil', 'Quiver Dance', 'String Shot'],
  ...
  },
  {
    ...
    tmPool: ['Body Slam', 'Double-Edge', 'Extreme Speed', 'Shadow Ball', 'Thunderbolt', 'Fire Blast', 'Swords Dance', 'Head Charge', 'Facade', 'Rapid Spin', 'Defog', 'Hidden Power', 'Agility', 'Charm', 'Growl', 'Leer', 'Scary Face', 'Screech', 'Sing', 'Slam', 'Strength', 'Struggle', 'Tackle', 'Tail Whip', 'Take Down', 'Shell Smash'],
...
export const PACK_TIERS: PackTierDef[] = [
  ...
  },
  {
    ...
    costMultiplier: 6,
    cards: 7,
    weights: { common: 8, uncommon: 30, rare: 41, epic: 21, legendary: 0 },
  ...
  },
  {
    ...
    costMultiplier: 15,
    cards: 7,
    weights: { common: 0, uncommon: 10, rare: 31, epic: 58, legendary: 1 },
    guaranteedHighTier: true,
    bonusTmCount: 2,
    bonusItemCount: 2,
  },
